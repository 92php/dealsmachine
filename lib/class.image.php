 ...
 * @version   $Id: class.image.php,v 1.1 2009/07/10 03:01:48 cvsuser Exp $
 +------------------------------------------------------------------------------
 */
class Image
{//类定义开始
     ...
     * @throws ThinkExecption
     +----------------------------------------------------------
     */
    static function buildImageVerify($length=4,$mode=3,$type='png',$width=48,$height=22,$verifyName='verify')
    {
		...
		//$font = "arial.ttf";
		//@imagettftext ($im, 18, 0, 0, 16, $stringColor, $font, $randval);
        @imagestring($im, 6, 5, 3, $randval, $stringColor);
