...
class webmoney
{
    ...
    function get_code($order)
    {
        ...
        $data_notify_url    = DOMAIN_CART.'/m-flow-a-payok-code-webmoney.htm'; // 付款响应页面
		...
		<input type="hidden" name="paymethod"  id="paymethod" value=841 />
		...
		<input type="submit" value="Pay by Webmoney" class = "formsubbotton">
		</form>';
