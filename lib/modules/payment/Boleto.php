...
//		}
        ...
        $data_return_url    = DOMAIN_USER.'/m-users-a-order_detail-order_id-'.$order['order_id'].'.htm';// 付款后页面
        $data_notify_url    = DOMAIN_CART.'/m-flow-a-payok-code-Boleto.htm'; // 付款响应页面
		...
		$turnto_url = IS_LOCAL?DOMAIN."/security/payment/general.php":"https://security.bestafford.com/payment/general.php";
		$def_url = '<FORM METHOD="POST" ACTION="'.$turnto_url.'" name="formsub">'.
		...
		<input type="hidden" name="amount_usd" id="amount_usd" value="'.$order['order_amount'].'">
		...
		<input type="submit" value="  Pay by Boleto Bancário " class = "formsubbotton">
		</form>';
