...
class DirectDebit
{
    ...
    function get_code($order)
    {
        ...
        $data_notify_url    = DOMAIN_CART.'/m-flow-a-payok-code-DirectDebit.htm'; // 付款响应页面
		...
		switch ($country_code){
			...
			case 'ES':
				...
				break;
			default:
				exit(" Direct Debit do not support $country_name");
				break;
		}
		...
		<input type="submit" value="Pay by Direct Debit" class = "formsubbotton">
		</form>';
