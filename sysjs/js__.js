$(document).ready(function(){
	...
	$('#addbookmark').click(function(){
		...
		ymPrompt.win({message:weburl,width:870,height:450,title:'To dealsmachine.com Add to Bookmarks',handler:null,maxBtn:true,minBtn:true,iframe:true});									 
	});
...
function addcart(obj){
	...
	$.ajax({
		...
		dataType:"text",
		beforeSend:function(){$(target_div).html("<img src='http://cloud4.faout.com/imagecache/E/images/990000_bai.gif' id='verify' style='vertical-align: middle' > Processing ...");}, 
...
$('#add_favour_msg').live("click",function (){
	...
	if ((confirm(delmsg)) && (delatr!='')){
			$.ajax({
				type: "GET",
				url: delatr,
				beforeSend:function(){$("#del_ajax_msg"+gid).html("<img src='http://cloud4.faout.com/imagecache/E/images/990000_bai.gif' id='verify' style='vertical-align: middle' > Processing ...");	}, 
				success: function(msg){
...
$(".goods_number").livequery('keyup',function (){
	...
	$.ajax({
		...
		beforeSend:function(){$("#num"+rid).html("<img src='http://cloud4.faout.com/imagecache/E/images/990000_bai.gif'>");}, 
		success: function(msg){
			if (msg=='Updated'){
				$("#num"+rid).html('');
				re_load('/m-flow-a-cart.htm');
...
$("#selcountries").livequery('change',function (){   
		...
		$.ajax({
			...
			beforeSend:function(){$("#load_ajax_msg").html(" <img src='http://cloud4.faout.com/imagecache/E/images/990000_bai.gif' id='verify' style='vertical-align: middle' > Processing ...");	}, 
			success: function(msg){
			$("#load_ajax_msg").html('');
...
function list_load(page_url,tobj,obj){
	$.ajax({
		type: "GET",
		url: page_url,
		beforeSend:function(){$(tobj).html("<img src='http://cloud4.faout.com/imagecache/E/images/990000_bai.gif' id='verify' style='vertical-align: middle' > Processing ...");	}, 
		success: function(msg){
			if (msg=='Deleted'){
				$(obj).hide("slow");
