...
window.fbAsyncInit = function() {
    FB.init({ appId: '219351824856094', status: true, cookie: true, oauth: true, xfbml: true });
};
(function() {
    ...
    if(status==1)
    {
        ...
        $.ajax({
            ...
            success:function(result){
                window.location.href = 'http://www.dealsmachine.com/' + js_cur_lang_url + 'm-users-a-order_list.htm';
            }
        });	
    }
}
