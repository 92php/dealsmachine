...
__ci.document.writeln('body {font-size:10px;margin:0px;text-align:center;font-family: Arial;}');
__ci.document.writeln('form {margin:0px;}');
__ci.document.writeln('select {font-size:10px;background-color:#EFEFEF;}');
__ci.document.writeln('table {border:0px solid #CCCCCC;background-color:#FFFFFF}');
__ci.document.writeln('th {font-size:10px;font-weight:normal;background-color:#FFFFFF;}');
...
__ci.document.writeln('td {font-size:10px;text-align:center;}');
...
__ci.document.writeln('input.l {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:20px;height:20px;font-size:10px;}');
__ci.document.writeln('input.r {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:20px;height:20px;font-size:10px;}');
__ci.document.writeln('input.b {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:100%;height:20px;font-size:10px;}');
__ci.document.writeln('-->');
