...
var IS_LOCAL = document.location.hostname == 'www.dealsmachine.com' || document.location.hostname.indexOf('.178') > -1 ? false : true;

var C = {
    WEBSITE: 'http://' + document.location.host + '/',
    IMGCACHE_URL: IS_LOCAL ? '/temp/skin3/' : 'http://cloud4.faout.com/imagecache/A/',
    JSCACHE_URL: IS_LOCAL ? '/' : 'http://cloud4.faout.com/imagecache/A/',
    /**
     * ajax回调函数
     *
