<?php
    ...
    */
    $mail->setFrom('bestafford.com <server@bestafford.com>');
    ...
    */
    $mail->setHTML('<b>Sample HTML</b> <img src="http://mimg.126.net/logo/163logo.gif"><br><br><br><br><br><br><br> <font color="#ff0000">wuwenlong</font>');
    ...
    */
    $mail->setReceipt('server@bestafford.com');
