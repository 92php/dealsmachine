...
var insurance,pro_total,shipping,tracking_number_fee,point_money;
...
function changeShip(p){
	...
	try{
		if(document.getElementById("flat").checked){
			...
			document.getElementById("chinapost_ship_tips").style.display="none";	
			change_tracking_check(0);
			
		}
		else if	(document.getElementById("chinapost").checked){
			document.getElementById("chinapost_ship_tips").style.display="";	
			change_tracking_check(0);
			document.getElementById("flat_ship_tips").style.display="none";	
		}	
		else{
			//i$("Tracking_number_checked").checked="false";
			document.getElementById("flat_ship_tips").style.display="none";	
			document.getElementById("chinapost_ship_tips").style.display="none";	
			change_tracking_check(0);	
		}
...
function change_tracking_check(b){
	if(document.getElementById("flat").checked){ 
		if(b){
			tracking_number_fee = Number(i$("Tracking_number_checked").value);
...
function caculate_total(){
	...
	//}
	//if(i$("Tracking_number_checked").checked){
	//	total = total+Tracking_number_checked;
	//}
	i$("total").innerHTML="US $" + total.toFixed(2);
	i$("total").setAttribute("USD", total);	
	return total;
